...
var createConfig = function (dir) {
    var fileTemplate = "{\n    \"directory\": \"" + dir + "\"\n    }";
    (0, fs_1.writeFileSync)('./config.json', fileTemplate);
};
exports.createConfig = createConfig;
var envCreator = function (dir, subdir) {
    var data = (0, fs_1.readFileSync)(dir + "/" + subdir + "/sample.env");
    (0, fs_1.writeFile)(dir + "/" + subdir + "/.env", data, function (err) {
        if (err) {
            log(err);
        }
    });
...
var configFileGenerator = function (answers) {
    ...
    (0, fs_1.writeFileSync)(answers.name + "/chewy.json", JSON.stringify(template, null, 2));
};
...
var rootGitIgnore = function (dir) {
    (0, fs_1.writeFileSync)(dir + "/.gitignore", constants_1.gitignoreTemplate);
};
...
var createAppConfigExpo = function (answers) {
    ...
    (0, fs_1.writeFileSync)(answers.name + "/mobile/app.config.js", template);
};
exports.createAppConfigExpo = createAppConfigExpo;
var rootReadmeFile = function (dir) {
    (0, fs_1.writeFileSync)(dir + "/README.md", constants_1.readmeFileTemplate);
};
...
var rootDockerFile = function (dir) {
    ...
    (0, fs_1.writeFileSync)("" + dir, dockerFile);
};
